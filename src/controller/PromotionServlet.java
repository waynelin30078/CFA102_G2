	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("getOne_For_Display".equals(action)) { // 來自select_page.jsp的請求
			...
			try {
				...
				String url = "/promotion/listOnePromotion.jsp";
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				/***************************3.查詢完成,準備轉交(Send the Success view)************/
				req.setAttribute("promotionVO", promotionVO);         // 資料庫取出的empVO物件,存入req
				String url = "/promotion/update_promotion_input.jsp";
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/promotion/listAllPromotion.jsp");
				failureView.forward(req, res);
			}
		}
		...
		if ("update".equals(action)) { // 來自update_emp_input.jsp的請求
			...
			try {
				...
				String promNameReg = "^[(\u4e00-\u9fa5)(a-zA-Z0-9_)]{2,10}$";
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/promotion/update_promotion_input.jsp");
				failureView.forward(req, res);
			}
		}
