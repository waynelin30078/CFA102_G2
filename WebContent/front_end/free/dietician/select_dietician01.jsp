       ...
       <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="single-courses">
                                <div class="courses-images">
                                    <a href="<%=request.getContextPath()%>/dietician/dietician.do?action=one_dietician_page&dno=${dieticianVO.dno}"><img height="220" width="220" src="<%=request.getContextPath()%>${dieticianVO.dpic}" alt="courses"/></a>
                                </div>
